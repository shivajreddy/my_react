...
export function App() {
    ...
    return (
        <div className="min-h-screen bg-gray-900 p-4">
            <div className="max-w-5xl mx-auto bg-black border-2 border-gray-600 rounded-lg">
                {/* Header */}
                <div className="bg-black border-b-2 border-gray-600 p-4">
                ...
                <div className="p-6">
                    ...
                    <button className="mb-8 px-4 py-2 bg-blue-600 text-white text-sm rounded hover:bg-blue-700 transition-colors">
                        VIEW DRAWINGS ON BIM360 DOCS
                    </button>
                        ...
                        {[1, 2, 3].map((num) => (
                            <div key={num} className="space-y-3">
                                <div className="flex items-center justify-between mb-2">
                                    <span className="text-gray-400 text-sm">choose file {num}</span>
                    ...
                    <div className="mb-6">
                        <div className="flex items-center gap-4 mb-4">
                            ...
                            <button className="px-4 py-1 bg-orange-600 text-white text-sm border border-orange-500 rounded hover:bg-orange-700 transition-colors">
                                dd-mm-yy
                            </button>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea
                            ...
                            className="w-full h-32 px-3 py-2 bg-gray-900 text-gray-300 border border-gray-600 rounded focus:outline-none focus:border-blue-500 resize-none"
